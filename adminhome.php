    ...
    <div class="header-area"> 
		...
		<div class="chome"> 
			<div class="cus-top text-center"> 
				<div class="container"> 
					<h2 style="margin-left: 7%">Pharmacy Panel</h2>
				</div>
			</div>
			...
			<div class="port-bottom"> 
				<div class="container"> 
					...
					<div class="img col-md-4"><a href="adaddmed.php"><img src="6.png" style="max-height: 100%;max-width: 70%;margin-bottom: 15px;margin-left: 15%;"alt="" /></a></div>
					</div>
