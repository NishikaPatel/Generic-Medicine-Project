...
<body>
    <div class="header-area"> 
		...
		<div class="login">
					...
					<div class="img col-md-3" style="margin: 2%;background-color: #e3e8ef;border: 1px #e3e8ef;border-radius: 5%; opacity:0.0;filter: alpha(opacity=60);text-align: center;margin-left: 5%;padding-top: 2%;padding-bottom: 2%;box-shadow: 1px 1px #989ba0;margin-top: 4%"><a href="#"><img src="#" alt=""  style="max-height: 10%;max-width: 10%"></a>
					
                    <br>
                        <label style="margin-left: 15%;margin-top: 2%">Find Ambulance</label>
					</div>
				
					<div class="img col-md-3" style="margin: 2%;background-color: #e3e8ef;border: 1px #e3e8ef;border-radius: 5%; opacity:0.9;filter: alpha(opacity=60);text-align: center;margin-left: 5%;padding-top: 2%;padding-bottom: 2%;box-shadow: 5px 10px #989ba0;margin-top: 4%"><a href="cusfindphar.php"><img src="img/aesulapian-staff-308760_640.png" alt="" style="max-height: 29%;max-width: 29%;margin-left: 12%"></a>
					<br>
