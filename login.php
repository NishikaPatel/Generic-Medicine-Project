...
<body class="cus">
<div class="header-area" style="background:rgb(255, 0, 0,0.8); ">
<div class="header-top">
<!-- <img src="img/client-1295901_960_720.png" style="max-height: 5%;max-width: 5%;margin-left: 48%;opacity:1.0;"> <h1 style="text-align: center;color: black">Generic Medicine</h1>-->
<div class="container">
<div class="logo col-md-3">
<img src="images/logo2.png" alt="" height="80">
</div>
...
mysqli_select_db($con,'medicineguide'); $result = mysqli_query($con,"SELECT * FROM customerlogin where cuUserName='".$username."' and cuPassword='".$password."';") or die("Failed to Login".mysql_error()); $row = mysqli_fetch_array($result); if($row["cuUserName"]==$username && $row["cuPassword"]==$password)
{
